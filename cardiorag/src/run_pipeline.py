"""
Pipeline orchestrator for the CardioRAG WHO03 processing pipeline.
...
from src.metadata_extractor import build_chunk_metadata
...
"""
    ...
    stats_path = str(PROJECT_ROOT / "data" / "processed" / "who03_stats.json")
...
def run_pipeline(pdf_path: str = None):
    ...
    # Write outputs
    json_path = os.path.join(output_dir, "who03_chunks.json")
    jsonl_path = os.path.join(output_dir, "who03_chunks.jsonl")
    preview_path = os.path.join(output_dir, "who03_chunks_preview.md")
    ...
    print(f"  Stats:    {os.path.join(output_dir, 'who03_stats.json')}")
