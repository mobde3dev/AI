...
def validate_gates(nice_chunks: List[Dict[str, Any]], who_chunks: List[Dict[str, Any]]):
    ...
    # V3: Every "N. RECOMMENDATION" text lives in a chunk whose subsection number == N.
    for c in all_chunks:
        cid = c["chunk_id"]
        m = c.get("metadata", {})
...
def main():
    ...
    parser.add_argument("--nice-pdf", default="data/raw/NICE3.pdf", help="Path to NICE3.pdf")
    parser.add_argument("--who-pdf",  default="data/raw/WHO03.pdf",  help="Path to WHO03.pdf")
